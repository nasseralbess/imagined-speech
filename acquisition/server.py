...
def _load_dotenv():
    """Minimal .env loader (no external dependency). Looks for a .env at the
    repo root and populates os.environ for any keys not already set."""
...
async def start_recording(request: RecordRequest):
    ...
    r.record_export_folder = os.environ.get(
        'EXPORT_FOLDER',
